...
export const parametersApp = {
	...
	style: `
		...
		.collapsible {
			cursor: pointer; padding: 12px 18px; width: 100%; border: none; text-align: left; outline: none;
			font-size: 1.1em; font-family: 'Undertale', 'Roboto', sans-serif;
			color: var(--accent-color); background: #eee;
			display: flex; justify-content: space-between; align-items: center;
		}
		.collapsible:after { content: '+'; font-size: 18px; font-weight: bold; margin-left: 5px; }
