			...
			<div id="projects-page">
				...
				<div id="projects-grid">
					<div class="project-card" data-project="1">
						<img src="./assets/img/polyadventure-capture.png" alt="PolyAdventure">
					...
					<div class="project-card" data-project="3">
						<img src="./assets/img/holonome-robot-capture1.png" alt="Robot Holonome">
						<div class="project-card-title">Robot Holonome</div>
					</div>
					<div class="project-card" data-project="4">
						<img src="./assets/img/batspy_logo.jpg" alt="Gite Chauves-souris">
